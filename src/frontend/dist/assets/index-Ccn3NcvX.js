...
const Gift = createLucideIcon("gift", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PRODUCT_IMAGE = "/assets/uploads/image-019d244a-6039-7216-89e6-b7d08c6c35bf-1.png";
function TopBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-brand-charcoal text-white text-center py-2 px-4 text-xs sm:text-sm font-medium", children: "🚚 FREE SHIPPING on orders of 6 bottles  |  🛡️ 180-Day Money-Back Guarantee" });
}
function Navbar() {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "text-brand-orange w-7 h-7" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xl font-extrabold tracking-tight text-brand-charcoal", children: [
              "CitrusBurn",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-orange", children: "™" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-7 text-sm font-semibold text-gray-700", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-brand-orange hover:bg-brand-orange-dark text-white rounded-full px-6 font-bold uppercase text-sm", children: "ORDER NOW" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden bg-white border-t border-gray-100 px-4 pb-4 flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: ORDER_URL, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-brand-orange hover:bg-brand-orange-dark text-white rounded-full w-full font-bold uppercase", children: "ORDER NOW" }) })
        ] })
      ]
    }
  );
...
function HeroSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative bg-gradient-to-br from-orange-500 via-brand-orange to-orange-600 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 py-16 md:py-24 grid md:grid-cols-2 gap-10 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-white z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 bg-white/20 text-white text-xs font-bold uppercase px-3 py-1 rounded-full mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-3.5 h-3.5" }),
          " Plant-Based • Natural • Non-GMO"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl md:text-5xl font-extrabold leading-tight mb-4", children: "Clean, Plant-Based Support for Metabolism & Fat Efficiency" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/90 text-base md:text-lg mb-8 leading-relaxed", children: "CitrusBurn is a natural thermogenic supplement formulated with plant-based ingredients to support healthy metabolism, efficient fat utilization, and steady energy — without harsh stimulants." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "bg-white text-brand-orange hover:bg-gray-100 rounded-full px-8 py-5 text-base font-bold shadow-lg w-full sm:w-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-brand-charcoal hover:bg-gray-800 text-white rounded-full px-8 py-5 text-base font-bold shadow-lg w-full sm:w-auto", children: "Buy Now — $49/Bottle" })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mt-6 text-white/80 text-sm", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
          src: PRODUCT_IMAGE,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0", "aria-hidden": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "svg",
      {
        viewBox: "0 0 1440 60",
        fill: "none",
...
function FeatureIconRow() {
  const features = [
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "w-8 h-8" }), label: "Boost Metabolism" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "w-8 h-8" }), label: "Increases Energy" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "w-8 h-8" }), label: "Targets Stubborn Fat" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Leaf, { className: "w-8 h-8" }), label: "Natural Ingredients" }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white py-10 border-b border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs uppercase tracking-widest font-bold text-brand-orange mb-6", children: "FUEL YOUR JOURNEY" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-6", children: features.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col items-center gap-3 text-center",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-brand-beige flex items-center justify-center text-brand-orange", children: f.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-sm text-brand-charcoal uppercase tracking-wide", children: f.label })
        ]
      },
      i
    )) })
...
function WhatIsCitrusBurn() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest font-bold text-brand-orange mb-2", children: "About The Product" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-brand-charcoal mb-5", children: "What Is CitrusBurn?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 text-gray-600 leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "CitrusBurn is a plant-based dietary supplement developed to support natural fat metabolism and overall metabolic health. It is designed for adults seeking a practical and sustainable approach to weight management — without extreme restrictions or stimulant-heavy formulas." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The formula includes research-backed ingredients such as Seville Orange Peel, Green Tea Extract, Ginger Root, and Red Pepper Extract. These components work together to support thermogenesis, improve calorie utilization, and promote metabolic efficiency." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Manufactured in the USA using non-GMO ingredients and designed for convenient daily use, CitrusBurn provides a reliable option for long-term metabolic support, sustained energy, and overall wellness." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "a",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-brand-orange hover:bg-brand-orange-dark text-white rounded-full px-7 py-4 font-bold", children: "Order CitrusBurn Today" })
        }
      )
    ] }),
...
function HowItWorks() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-brand-beige py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center order-2 md:order-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: PRODUCT_IMAGE,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-1 md:order-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest font-bold text-brand-orange mb-2", children: "The Science" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-brand-charcoal mb-5", children: "How Does CitrusBurn Work?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-gray-600 leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "CitrusBurn works by supporting the body's natural metabolic and thermogenic pathways that help convert stored fat into usable energy, allowing calories to be burned more efficiently throughout the day." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Ingredients such as Seville Orange Peel and Green Tea Extract help stimulate thermogenesis, while Red Pepper Extract supports increased calorie burning after meals. Ginger Root contributes to digestive comfort and helps support balanced appetite control." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "CitrusBurn also encourages continued metabolic activity by supporting calorie utilization even during periods of rest, which may assist with managing stubborn fat and supporting long-term weight goals." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "With consistent daily use, CitrusBurn supports steady energy, improved fat metabolism, enhanced metabolic efficiency, and long-term weight management." })
      ] })
    ] })
  ] }) });
}
function BenefitsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "benefits-section", className: "bg-brand-beige py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs uppercase tracking-widest font-bold text-brand-orange mb-2", children: "Why It Works" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-brand-charcoal text-center mb-10", children: "BENEFITS" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-5", children: benefits.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-white rounded-xl p-5 shadow-card flex gap-4",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl flex-shrink-0", children: b.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-brand-charcoal text-sm mb-1", children: b.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm leading-relaxed", children: b.desc })
          ] })
        ]
      },
      i
...
function IngredientsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "ingredient-section", className: "bg-white py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs uppercase tracking-widest font-bold text-brand-orange mb-2", children: "Formula" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-brand-charcoal text-center mb-3", children: "Key Ingredients" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-gray-500 mb-10 max-w-xl mx-auto", children: "Each serving features a targeted blend of citrus extracts and botanical compounds chosen for their metabolic support properties." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: ingredients.map((ing, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-2xl border border-gray-100 shadow-card p-6 hover:shadow-lg transition-shadow",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: ing.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-extrabold text-brand-charcoal mb-2", children: ing.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm leading-relaxed", children: ing.desc })
        ]
      },
      i
    )) })
...
function PricingSection() {
  const plans = [
    ...
    },
    {
      ...
      perBottle: "$39/bottle",
      tag: "BEST VALUE",
      savings: "Save $240 + 2 Free Bonuses",
      shipping: "Free Shipping"
    }
  ];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-brand-beige py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs uppercase tracking-widest font-bold text-brand-orange mb-2", children: "Special Offer" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-brand-charcoal text-center mb-2", children: "Limited-Time Special Pricing" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-gray-500 mb-10", children: "Get Your CitrusBurn While Supplies Last" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6 mb-10", children: plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `relative bg-white rounded-2xl shadow-card p-7 flex flex-col items-center border-2 ${plan.tag === "MOST POPULAR" ? "border-brand-orange" : "border-transparent"}`,
        children: [
          plan.tag && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-3 left-1/2 -translate-x-1/2 bg-brand-orange text-white text-xs font-bold px-4 py-1 rounded-full uppercase", children: plan.tag }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-extrabold text-brand-charcoal text-lg mb-1", children: plan.qty }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-4xl font-extrabold text-brand-orange mb-1", children: plan.price }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mb-1", children: plan.perBottle }),
          plan.savings && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-600 font-bold text-sm mb-1", children: plan.savings }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mb-5", children: plan.shipping }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: ORDER_URL,
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "w-full bg-brand-orange hover:bg-brand-orange-dark text-white rounded-full font-bold py-5 uppercase", children: "ORDER NOW" })
            }
          )
        ]
      },
...
function ReviewsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "reviews-section", className: "bg-white py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs uppercase tracking-widest font-bold text-brand-orange mb-2", children: "Real Results" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-brand-charcoal text-center mb-10", children: "CitrusBurn Reviews" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-6", children: reviews.map((r2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-white rounded-2xl border border-gray-100 shadow-card p-6 flex flex-col",
        "data-ocid": `reviews.item.${i + 1}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex text-yellow-400 mb-3", children: [...Array(5)].map((_, si) => (
            // biome-ignore lint/suspicious/noArrayIndexKey: static star array
            /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-current" }, si)
          )) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-bold text-brand-charcoal mb-3", children: [
            '"',
            r2.title,
            '"'
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm leading-relaxed flex-grow", children: r2.text }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-gray-100", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-brand-charcoal text-sm", children: r2.name }),
...
function BonusesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-brand-charcoal py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs uppercase tracking-widest font-bold text-brand-orange mb-2", children: "Exclusive Bonuses" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl md:text-3xl font-extrabold text-white text-center mb-8", children: [
      "Order 6 or 3 Bottles and Receive",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-orange", children: "2 FREE Bonuses!" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 rounded-2xl p-6 border border-white/10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-brand-orange rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Gift, { className: "w-5 h-5 text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-orange text-xs font-bold uppercase", children: "Bonus #1" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-extrabold", children: "Spanish Rapid Detox Protocol" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-green-400 font-bold text-sm", children: "100% FREE" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm leading-relaxed", children: "A straightforward 15-day, Mediterranean-inspired guide created to help support natural detox pathways and encourage thermogenic activity using common, everyday ingredients." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/10 rounded-2xl p-6 border border-white/10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-brand-orange rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-5 h-5 text-white" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-orange text-xs font-bold uppercase", children: "Bonus #2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-extrabold", children: "Mind Over Metabolism Mastery" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-auto text-green-400 font-bold text-sm", children: "100% FREE" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 text-sm leading-relaxed", children: "A guided mindset program featuring short daily exercises designed to help reduce cravings, manage emotional eating, and build lasting motivation for healthier lifestyle habits." })
      ] })
    ] })
  ] }) });
}
function GuaranteeSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white py-14", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center justify-center w-20 h-20 bg-green-100 rounded-full mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-10 h-10 text-green-600" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-extrabold text-brand-charcoal mb-4", children: "180-Day Money-Back Guarantee" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 leading-relaxed mb-6", children: "CitrusBurn is supported by a strong commitment to quality and customer satisfaction. Every order is covered by a full 180-day money-back guarantee. If you are not completely satisfied for any reason, simply contact our support team within 180 days to receive a full refund." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-brand-charcoal", children: "No hassle. No complicated process. No risk." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-sm mt-1", children: "We stand behind every CitrusBurn purchase so you can try it with complete confidence." })
  ] }) });
}
function CertificationsRow() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-brand-beige py-8 border-y border-orange-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-4xl mx-auto px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: certs.map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "flex items-center gap-2 justify-center",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "w-5 h-5 text-brand-orange flex-shrink-0" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-brand-charcoal text-sm", children: c.label })
      ]
    },
    i
  )) }) }) });
...
function FaqSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "FAQ-section", className: "bg-white py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs uppercase tracking-widest font-bold text-brand-orange mb-2", children: "Common Questions" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl md:text-4xl font-extrabold text-brand-charcoal text-center mb-10", children: "Frequently Asked Questions" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "single", collapsible: true, className: "space-y-3", children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      AccordionItem,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-bold text-brand-charcoal hover:no-underline hover:text-brand-orange", children: faq.q }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "text-gray-500 leading-relaxed", children: faq.a })
        ]
      },
      i
    )) })
...
function FinalCTA() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-brand-beige py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl font-extrabold text-brand-charcoal text-center mb-10", children: "Quick Savings: Secure Your Discounted CitrusBurn Bottle Now!" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-10 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 line-through text-lg mb-1", children: "Regular Price: $79/Bottle" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-extrabold text-brand-orange mb-5", children: "Today Just: $49/Bottle" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: ORDER_URL,
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "bg-brand-orange hover:bg-brand-orange-dark text-white rounded-full px-8 py-6 text-base font-extrabold uppercase shadow-lg w-full md:w-auto", children: "CLAIM MY DISCOUNTED BOTTLE NOW!" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 mt-5 justify-center md:justify-start", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-sm text-gray-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "w-4 h-4 text-green-600" }),
            " 180-Day Guarantee"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-sm text-gray-600", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { className: "w-4 h-4 text-brand-orange" }),
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-brand-charcoal text-white py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-4 mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Flame, { className: "text-brand-orange w-6 h-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-extrabold", children: [
          "CitrusBurn",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-orange", children: "™" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-5 justify-center text-sm text-white/60", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: ORDER_URL,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/10 pt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/50 text-xs leading-relaxed mb-4 max-w-4xl mx-auto text-center", children: "The information shared on this website has not been reviewed or approved by the Food and Drug Administration (FDA) or any other medical or regulatory authority. All content is provided for general informational and educational purposes only and should not be considered medical advice, nor used to diagnose, treat, cure, or prevent any disease or health condition. Always consult a licensed physician or qualified healthcare professional before making any health-related decisions. These statements have not been evaluated by the FDA. This product is not intended to diagnose, treat, cure, or prevent any disease." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/40 text-xs text-center", children: [
        "Copyright © ",
        year,
        " CitrusBurn – All Rights Reserved. Built with love using",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureIconRow, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WhatIsCitrusBurn, {}),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(BonusesSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(GuaranteeSection, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CertificationsRow, {}),
